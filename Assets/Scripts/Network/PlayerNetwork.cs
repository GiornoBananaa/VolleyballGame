...
public class PlayerNetwork : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            transform.rotation = Quaternion.Euler(0, Mathf.SmoothDampAngle(transform.rotation.eulerAngles.z, _netState.Value.Rotation.z, ref _rotVel, _cheapInterpolationTime), 0);
        }
    }
